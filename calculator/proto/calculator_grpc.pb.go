...
type CalculatorServiceClient interface {
	...
	PrimeFactors(ctx context.Context, in *PrimeFactorsRequest, opts ...grpc.CallOption) (CalculatorService_PrimeFactorsClient, error)
...
func (c *calculatorServiceClient) PrimeFactors(ctx context.Context, in *PrimeFactorsRequest, opts ...grpc.CallOption) (CalculatorService_PrimeFactorsClient, error) {
	stream, err := c.cc.NewStream(ctx, &CalculatorService_ServiceDesc.Streams[0], "/CalculatorService/PrimeFactors", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *calculatorServicePrimeFactorsClient) Recv() (*PrimeFactorsResponse, error) {
...
func (c *calculatorServiceClient) Max(ctx context.Context, opts ...grpc.CallOption) (CalculatorService_MaxClient, error) {
	stream, err := c.cc.NewStream(ctx, &CalculatorService_ServiceDesc.Streams[2], "/CalculatorService/Max", opts...)
	if err != nil {
		return nil, err
	}
...
type CalculatorServiceServer interface {
	...
	PrimeFactors(*PrimeFactorsRequest, CalculatorService_PrimeFactorsServer) error
...
func (UnimplementedCalculatorServiceServer) PrimeFactors(*PrimeFactorsRequest, CalculatorService_PrimeFactorsServer) error {
...
func (x *calculatorServicePrimeFactorsServer) Send(m *PrimeFactorsResponse) error {
